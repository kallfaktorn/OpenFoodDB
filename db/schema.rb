...
ActiveRecord::Schema.define(:version => 20130912113020) do
  ...
  create_table "food_stuffs", :force => true do |t|
    ...
    t.integer  "weight"
    t.string   "storage"
    t.string   "categories_field"
  end

  create_table "food_stuffs_categories", :id => false, :force => true do |t|
    t.integer "food_stuff_id"
  ...
  create_table "multilanguage_support_ingredients", :force => true do |t|
    t.string   "en"
    t.string   "se"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
